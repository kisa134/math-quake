...
const HELP: [string, string][] = [
  ...
  ['SHIFT', 'прицел (ADS): зум и точность'],
  ...
  ['R', 'СТРОЙКА (вкл/выкл): скролл деталь · Q поворот · [ ] размер · G статик/физика'],
      ...
      <div className="max-w-6xl mx-auto p-6 flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <Section title={`Стройка — палитра (${placedCount}/300) · клик = выбрать и строить`}>
            ...
            <div className="font-mono text-[10px] text-white/35 mt-2">R в игре — вкл/выкл стройку · скролл деталь · Q поворот · [ ] размер ×0.25–30 · G статик/физика · ЛКМ ставит / ПКМ удаляет</div>
          </Section>
